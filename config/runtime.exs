...
#
#     PHX_SERVER=true bin/agent_desk start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :agent_desk, AgentDeskWeb.Endpoint, server: true
end

if config_env() == :prod do
  data_root =
    System.get_env("AGENT_DESK_DATA_ROOT") ||
      AgentDesk.Storage.default_data_root()
  ...
  config :agent_desk, AgentDeskWeb.Endpoint,
    ...
    http: [
      # Desktop control plane is loopback-only. See docs/SECURITY.md.
      ip: {127, 0, 0, 1},
      port: port
    ],
