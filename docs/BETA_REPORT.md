...
| Release CI source gate | passed; configuration blocked | [Manual run 35663188771](https://github.com/mpakus/cuckoding.com/actions/runs/35663188771) on `112473e` passed `mix quality` (288 tests, 10 properties, lint, security scan, dependency audit), then stopped at the value-free preflight for five missing Apple certificate/notary secrets. Import, packaging, and publication did not run. |
