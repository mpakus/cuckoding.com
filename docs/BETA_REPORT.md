...
| Current-source developer build | pass | 2026-09-21: `6ebbd6c` passed `bin/dev.build`; its sterile verifier passed startup, token/session, crash, safe-mode, and update/rollback checks. The separate signing drill is recorded below; neither step satisfies clean-Mac or enrollment-package acceptance. |
