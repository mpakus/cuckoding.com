...
| Release CI source gate | passed; configuration blocked | [Current-main run 35680103836](https://github.com/mpakus/cuckoding.com/actions/runs/35680103836) on `e96882b` passed `mix quality` (289 tests, 10 properties, zero failures), then stopped at the value-free preflight for the same five missing Apple certificate/notary secrets. Import, packaging, and publication did not run. |
