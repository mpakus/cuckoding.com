...
| Release CI source gate | passed; configuration blocked | [Current-main run 35680103836](https://github.com/mpakus/cuckoding.com/actions/runs/35680103836) on `e96882b` passed `mix quality` (289 tests, 10 properties, zero failures). [Checkout-pin branch run 35681124404](https://github.com/mpakus/cuckoding.com/actions/runs/35681124404) passed the same gate with the Node 24-native action. Both stopped at the value-free preflight for the five missing Apple certificate/notary secrets; import, packaging, and publication did not run. |
