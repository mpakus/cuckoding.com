...
The shared brand mark is a circular capital C with an attached, tapered sperm
tail flowing left, violet on a pearl tile. `desktop/icon.svg` is the editable source;
