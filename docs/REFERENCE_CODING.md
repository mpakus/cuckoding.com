...
```sh
rtk xerj autoindex . --dry-run --no-graph --prefix cuckoding-project-v3 --state-dir ~/.local/share/cuckoding/xerj/autoindex/cuckoding-project-v3 --progress plain
rtk xerj autoindex . --no-graph --prefix cuckoding-project-v3 --state-dir ~/.local/share/cuckoding/xerj/autoindex/cuckoding-project-v3 --progress plain --yes
```
...
```sh
rtk xerj search --prefix cuckoding-project-v3 -k 5 "event before broadcast durable state"
