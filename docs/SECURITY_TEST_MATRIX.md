...
| R9 duplicate work after sleep/crash | Lifecycle, command, reconciler, power-manager, and walking-skeleton tests cover idempotent commands, lease extension, append-before-broadcast, and single stage/push execution | Real provider resume behavior still needs the physical drill in Task 1002 |
