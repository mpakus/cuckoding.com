...
- [ ] One adapter, one board, host runner, no plugins.
- [ ] Use the fake adapter in CI; real adapter in the demo.
- [ ] Release handoff pushes to a local bare remote.

## Acceptance criteria

- [ ] A real task completes end to end with evidence bundle and branch.
- [ ] Sleep-gap simulation does not duplicate work.
- [ ] The team records a go/no-go on the product loop.
